...
newsscRape = function(oldfile = "R_News_13NOV17.csv", newfile = "R_News_13NOV17.csv"){
...
google <- c(
  "https://www.google.com/search?q=Puerto+Rico&num=100&tbs=sbd:1,qdr:m&tbm=nws&source=lnt&sa=X&ved=0ahUKEwj6wKTm6YnXAhUIHJQKHTU1CzsQpwUIHw&biw=1922&bih=951&dpr=1",
...
originslist = list()
  ...
  origins <- google[1] %>%
    ...
    html_nodes(".slp , ._gJs") %>%
    html_text()
  headlinelist[[1]] = headlines
  blurblist[[1]] = blurb
  originslist[[1]] = origins
